          ...
          >
            ...
            >
              <g>
                ...
                <path
                  id="textCircle"
                  d="M341,110 A50,50 0 1,1 341,10 A50,50 0 1,1 341,110"
                  fill="none"
                />
                <text fill="black" fontSize="8.5" fontWeight="bold" letterSpacing="1.5" style={{ fontFamily: "var(--font-basement-grotesque)" }}>
                  <textPath href="#textCircle" startOffset="50%" textAnchor="middle">
                    @BRAVOO.IN • ALL RIGHTS RESERVED • 2025
                  </textPath>
                </text>
              </g>
            </Scrollytelling.Animation>
